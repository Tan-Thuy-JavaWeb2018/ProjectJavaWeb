					...
					<div class="col-md-8 col-sm-9 col-xs-6">
						<div class="cart-menu">
							<div class="search-style-2 f-right">
								<a class="icon-search-2" href="#"> <i class="pe-7s-search"></i>
								</a>
							...
							<div class="user user-style-3 f-right">
								...
								<div class="currence-user-page">
									<div class="user-page">
										<ul>
											<li><a href="checkout.jsp"><i class="pe-7s-check"></i>
													Thanh toán</a></li>
											<li><a href="login.jsp"><i class="pe-7s-next-2"></i>
													Đăng nhập</a></li>
											<li><a href="register.jsp"><i class="pe-7s-add-user"></i>
													Tạo tài khoản mới</a></li>
										</ul>
									</div>
								</div>
							</div>
